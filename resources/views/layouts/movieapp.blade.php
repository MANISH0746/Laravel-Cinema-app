...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('tailwind/tailwind.css') }}">
...
<body class="antialiased">
    ...
    @if (Route::has('login'))
        <div class="Z-999 sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            @auth
                <a href="{{ url('/home') }}"
            ...
            @else
                <a href="{{ route('login') }}"
                    class="font-semibold hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Login</a>
    ...
    <div class="container">
        <nav class="navbar navbar-default navbar-custom">
            ...
            <div class="navbar-header logo">
                ...
                <a href="index-2.html"><img class="logo" src="assets/images/logo1.png" alt=""
